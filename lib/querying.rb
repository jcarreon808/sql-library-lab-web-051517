...
def select_name_and_series_subgenres_of_authors
  ...
  authors.id = series.author_id INNER JOIN subgenres on subgenres.id =series.subgenre_id; "
end
...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(character_books.book_id)from characters INNER JOIN character_books on characters.id = character_books.character_id GROUP BY characters.name ORDER BY COUNT(book_id) DESC;"
end
